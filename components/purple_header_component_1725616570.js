...
<template>
  <header class="w-full z-30" id="header-section-container" style="min-height: -10px">
        ...
        <div class="md:hidden flex items-center ml-4">
          ...
          >
            <ul id="mobile-nav-list" class="border border-transparent rounded-lg px-4 py-1.5 [background:linear-gradient(theme(colors.slate.900),_theme(colors.slate.900))_padding-box,_conic-gradient(theme(colors.slate.400),_theme(colors.slate.700)_25%,_theme(colors.slate.700)_75%,_theme(colors.slate.400)_100%)_border-box]">
              ...
              <li>
                <a id="mobile-Courses-link" class="flex font-medium text-sm py-1.5 text-slate-300 hover:text-white" href="Courses.html">Courses</a>
              </li>
              <li>
                <a id="mobile-Resources-link" class="flex font-medium text-sm py-1.5 text-slate-300 hover:text-white" href="Resources.html">Resources</a>
              </li>
              <li>
              ...
              <li>
                <a id="mobile-My Progress-link" class="flex font-medium text-sm py-1.5 text-slate-300 hover:text-white" href="My Progress.html">My Progress</a>
              </li>
            </ul>
          </nav>
        </div>
