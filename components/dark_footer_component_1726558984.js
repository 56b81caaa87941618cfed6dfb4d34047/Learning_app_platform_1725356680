...
<template>
  <footer id="footer-section-container" style="min-height: 150px"   >
...
<script>
export default {
  name: "dark_footer_component_1726558984",
  data() {
    return {
      expanded: false,
      tab: null,
